...
* [Getting started](getting-started/README.md)
  * [Install & Singing in](getting-started/install-and-singing-in/README.md)
    ...
    * [Creating a new wallet](getting-started/install-and-singing-in/creating-a-new-wallet/README.md)
      * [Creating a new wallet Extension](getting-started/install-and-singing-in/creating-a-new-wallet/creating-a-new-wallet-extension.md)
      * [Creating a new wallet App](getting-started/install-and-singing-in/creating-a-new-wallet/creating-a-new-wallet-app.md)
    * [Sign in with existing seed phrase](getting-started/install-and-singing-in/sign-in-with-existing-seed-phrase/README.md)
      * [Sign in with existing seed phrase Extension](getting-started/install-and-singing-in/sign-in-with-existing-seed-phrase/sign-in-with-existing-seed-phrase-extension.md)
      * [Sign in with existing seed phrase App](getting-started/install-and-singing-in/sign-in-with-existing-seed-phrase/sign-in-with-existing-seed-phrase-app.md)
...
* [stEVER](stever/README.md)
  * [About stEVER](stever/about-stever.md)
  * [How to get/unstake stEVER](stever/how-to-get-unstake-stever.md)
